...
public class AxisCommand extends FPSCommandBase{
	
	public AxisCommand(CommandSender sender, String[] args) throws NotIngameException, NoOnlinePlayerException, IngameException {
