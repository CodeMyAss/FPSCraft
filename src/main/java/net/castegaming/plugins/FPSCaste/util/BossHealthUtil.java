...
// IMPORTANT
// Remember to rename BukkitGames.getInstance() to your plugin's main class
...
public class BossHealthUtil {
  public static final int ENTITY_ID = 1234;
	 ...
	 * @param speed
	 */
	public static void updateTextBar(Player player, String text, int health) {
		DataWatcher watcher = getWatcher(text , health*3);
